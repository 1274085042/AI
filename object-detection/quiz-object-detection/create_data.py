...
#from research.object_detection.utils import dataset_util, label_map_uti
flags = tf.app.flags
...
def main(_):
    ...
    train_examples = examples_list[:num_train]   #70%是训练集
    val_examples = examples_list[num_train:]     #30%是测试集
